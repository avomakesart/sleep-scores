...
export const NotFoundIllustration = React.memo<JSX.IntrinsicElements['svg']>((props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 797.46 814.59" {...props}>
      <g id="Layer_2" data-name="Layer 2">
        <g id="vector">
          ...
          <path className="cls-4" d="M536.15,404.21c.86,8.18,18.93,360.89,18.93,360.89H536.15L444.1,433Z" />
          <path
          ...
          />
          <path className={styles['cls-6']} d="M503.78,188.72c0,3.71-22.63,4.65-22.63,0V146h22.63Z" />
          <ellipse className={styles['cls-9']} cx="484.29" cy="123.03" rx="29.54" ry="47.77" />
          ...
          <circle className={styles['cls-9']} cx="501.26" cy="134.34" r="7.54" />
        </g>
      </g>
    </svg>
  )
